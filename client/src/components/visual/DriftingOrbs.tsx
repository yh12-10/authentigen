  ...
  return (
    ...
    >
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(closest-side, rgba(245,166,35,0.12), transparent 70%)",
          filter: "blur(40px)",
        }}
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(closest-side, rgba(79,142,247,0.10), transparent 70%)",
          filter: "blur(50px)",
        }}
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(closest-side, rgba(245,166,35,0.05), transparent 70%)",
          filter: "blur(60px)",
        }}
