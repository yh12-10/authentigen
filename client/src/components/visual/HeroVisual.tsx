  ...
  return (
    <div className="relative w-full h-full">
      ...
      <div
        ...
        style={{ background: "radial-gradient(closest-side, rgba(79,142,247,0.4), transparent 70%)" }}
      />
      <div
        className="absolute top-1/2 left-1/2 size-48 -translate-x-1/2 -translate-y-1/2 rounded-full blur-2xl"
        style={{ background: "radial-gradient(closest-side, rgba(255,200,100,0.25), transparent 70%)" }}
      />
    </div>
  );
}
